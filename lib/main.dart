...
import 'package:flutter_mvvm_archit/utils/routes/routes.dart';
...
/*https://github.com/jitsm555/Flutter-MVVM/blob/master/lib/main.dart*/
    ...
    return MultiProvider(
        providers: [ChangeNotifierProvider(create: (_)=> AuthViewModel()),
         ChangeNotifierProvider(create: (_)=> HomeViewModel()),
          ChangeNotifierProvider(create: (_)=> SanctionViewModel()),
      ...
      initialRoute: RoutesName.sanction,
