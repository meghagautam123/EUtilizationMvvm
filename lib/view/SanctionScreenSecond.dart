...
class SanctionScreenSecond extends StatefulWidget {
  const SanctionScreenSecond({super.key});

  @override
  State<SanctionScreenSecond> createState() => _SanctionScreenState();
}

class _SanctionScreenState extends State<SanctionScreenSecond>
  {
  ...
  void _onTextClicked()
  {
    ...
    if(!displayMonthList && newText!=null)
    {
      print("displaymonthlisttrue");
      _isSanctionShow = true;
    }
    else {
      print("displaymonthlistfalse");
      _isSanctionShow = false;
    }
    _focusNode.unfocus();
  }
                            ...
                            decoration: InputDecoration(
                                ...
                                suffixIcon: GestureDetector(
                                  ...
                                  onTap: ()
                                  {
                                    setState(() {
                                      displayMonthList = !displayMonthList;
                                      //_isSanctionShow = !_isSanctionShow;
